...
cat << EOF > /home/jenkins/.docker/config.json
{
 "proxies": {
    "default": {
        "httpProxy": "http://CADAllpayVendor01:Avd%40%400113579@proxy-server.scg.com:3128/",
        "httpsProxy": "http://CADAllpayVendor01:Avd%40%400113579@proxy-server.scg.com:3128/",
...
su -c "git config --global http.proxy http://CADAllpayVendor01:Avd%40%400113579@proxy-server.scg.com:3128/" jenkins
su -c "git config --global https.proxy http://CADAllpayVendor01:Avd%40%400113579@proxy-server.scg.com:3128/" jenkins